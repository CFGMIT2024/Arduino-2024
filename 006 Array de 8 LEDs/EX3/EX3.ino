/**********************************************************************************
**                                                                               **
**                              Array de 8 LEDs       MARC ALVAREZ SALA          **
**                                                                               **
**                                                                               **
**********************************************************************************/
...
void loop()
{
  ...
  digitalWrite(led2, LOW);    // posar a 5V el pin 7
  digitalWrite(led5, LOW);    // posar a 5V el pin 107

  delay(1000);                  // es queden leds 50ms apagats
